// src/main/java/team/project/redboost/entities/TacheDocument.java
...
public class TacheDocument {
    ...
    @JsonIgnoreProperties({"documents", "activite", "hibernateLazyInitializer", "handler"})
    private Tache tache;
