...
!(function () {
    ...
    function W(t) {
        if (t && c) {
            ...
            for (
                var r = d.head.childNodes, a = null, n = r.length - 1;
                -1 < n;
                n--
            ) {
                var i = r[n],
    ...
    function xt(t) {
        return t.reduce(function (t, e) {
            ...
            if (yt[e]) t.prefix = e;
                ...
                var a =
                    "fa" === t.prefix
                        ? pt[r] || { prefix: null, iconName: null }
                        : {};
                ((t.iconName = a.iconName || r),
                    ...
                    U(t).forEach(function (t) {
                        if (
                            ("childList" === t.type &&
                                ...
                                !Nt(t.addedNodes[0]) &&
                                (T.searchPseudoElements && o(t.target),
                                n(t.target)),
                            "attributes" === t.type &&
                                t.target.parentNode &&
    ...
    var jt = function (t) {
            ...
            return (
                ...
                o.prefix && 1 < i.length
                    ? (o.iconName =
                          ((e = o.prefix), (r = t.innerText), ht[e][r]))
                    : o.prefix &&
                      1 === i.length &&
                        ...
                        value: function () {
                            ...
                            Object.keys(n).forEach(function (t) {
                                ((e.definitions[t] = E(
                                    ...
                                    (function t(e, a) {
                                        var r = Object.keys(a).reduce(function (
                                            t,
                                            e,
                                        ) {
                                            var r = a[e];
