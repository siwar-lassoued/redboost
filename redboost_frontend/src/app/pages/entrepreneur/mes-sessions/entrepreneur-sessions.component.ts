    ...
    <div class="p-6 bg-[#F8FAFC] min-h-screen relative">
      ...
      <div class="mb-6 relative">
        ...
        <input type="text" 
          ...
          class="w-full pl-11 pr-4 py-3.5 bg-white border border-gray-100 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#3B82A6] focus:border-transparent outline-none transition-all shadow-xl shadow-gray-200/50">
      </div>
