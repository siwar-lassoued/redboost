        ...
        >
          ...
          <div class="p-4 border-b border-gray-100">
            ...
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-9 pr-3 py-2 bg-gray-50 rounded-xl text-sm focus:outline-none text-gray-700"
          ...
          <div class="overflow-y-auto flex-1 custom-scrollbar">
            @if (isLoadingConversations()) {
              ...
              <div class="animate-spin w-6 h-6 border-2 border-t-transparent rounded-full mx-auto mb-2" style="border-color: #3B82A6; border-top-color: transparent;"></div>
                Chargement...
              </div>
              ...
              @for (conv of filteredConversations(); track conv.id) {
                <button
                  ...
                  [class.bg-blue-50]="selected()?.id === conv.id && !isMobileView()"
                >
          ...
          @if (selected()) {
            ...
            <div class="px-4 py-3.5 border-b border-gray-100 flex items-center gap-3 bg-white">
              ...
              <div class="relative flex-shrink-0">
                ...
                <div class="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-white" style="background: #10B981;"></div>
              </div>
              <div class="flex-1 min-w-0">
            ...
            <div class="p-3 border-t border-gray-100 flex items-center gap-2.5 bg-white relative">
              ...
              <button
                ...
                class="w-10 h-10 rounded-xl flex items-center justify-center text-white flex-shrink-0 transition-all hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                [style.box-shadow]="'0 4px 12px rgba(59,130,166,0.3)'"
                style="background: linear-gradient(135deg, #3B82A6, #2563A0);"
              >
