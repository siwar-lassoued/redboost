...
@Component({
  ...
  styles: [`
    ...
    .thematique-info-bar { display: flex; align-items: center; gap: 10px; padding: 10px 16px; background: #e6fcf5; border: 1px solid #c3fae8; border-radius: 12px; margin-bottom: 12px; font-size: 13px; color: #0ca678; }
    .thematique-info-bar i { font-size: 16px; flex-shrink: 0; color: #0ca678; }
    .tib-hint { margin-left: auto; font-size: 11px; color: #64748b; font-style: italic; }
