        ...
        <section class="service-section" #serviceSection>
            <div class="service-content">
                ...
                <div class="service-text">
                    <i
                        class="pi pi-code icon text-primary"
                    ...
                    <h2
                        ...
                        [@textAnimation]="isVisible ? 'visible' : 'hidden'"
                    >
                        Développement – Boostez votre présence en ligne
                    </h2>
                    <p
                        class="service-description"
                        [@textAnimation]="isVisible ? 'visible' : 'hidden'"
                    >
                        Nous vous aidons à structurer et développer votre projet
                        avec des solutions technologiques adaptées à votre
                        vision.
                    </p>
                    <ul
                        class="service-list"
