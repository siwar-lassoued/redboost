        ...
        <section class="service-section" #serviceSection>
            <div class="service-content">
                <div class="service-text">
                    <i
                        class="pi pi-chart-bar icon text-primary"
                    ...
                    <h2
                        ...
                        [@textAnimation]="isVisible ? 'visible' : 'hidden'"
                    >
                        Commercialisation – Boostez votre visibilité et vos
                        ventes
                    </h2>
                    <p
                        ...
                        [@textAnimation]="isVisible ? 'visible' : 'hidden'"
                    >
                        Une bonne idée ne suffit pas, il faut aussi savoir la
                        vendre ! Nous vous aidons à positionner et développer
                        votre marché.
                    </p>
                    <ul
                        class="service-list"
