...
<div class="scrollable-list">
  <div *ngFor="let m of filteredThematiqueMatchings"
       class="history-card"
       [class.history-valide]="m.statut === 'VALIDE'"
       [class.history-propose]="m.statut === 'PROPOSE'"
       [class.history-termine]="m.statut === 'TERMINE'"
       [class.history-libere]="m.statut === 'LIBERE'">
    ...
    <div class="hc-right">
      ...
      <span class="status-badge"
            ...
            [class.proposed]="m.statut === 'PROPOSE'"
            [class.expired]="m.statut === 'TERMINE' || m.statut === 'LIBERE'">
        {{ m.statut }}
      </span>
      ...
      <div style="display: flex; flex-direction: column; gap: 6px; margin-top: 8px;">
        ...
        <button class="btn-sm btn-sm-danger"
          ...
          {{ deletingMatchingId === (m.matchingId || m.id)
              ? '...'
              : 'Supprimer' }}
        </button>
