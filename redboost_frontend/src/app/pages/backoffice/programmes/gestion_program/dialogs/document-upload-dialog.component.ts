// src/app/pages/backoffice/programmes/Gestion_sprint/dialogs/document-upload-dialog.ts
    ...
    styles: [
        `
            ...
            .upload-drop-zone {
                ...
                @apply hover:border-[#E91E63] hover:bg-pink-50/30;
            }

            .upload-drop-zone.drag-over {
                @apply border-[#E91E63] bg-pink-50/50;
            }
            ...
            .browse-btn {
                @apply px-4 py-2 bg-[#E91E63] text-white rounded-md font-medium hover:bg-[#D81B60] transition-colors;
            }
...
export class DocumentUploadDialogComponent {
    // Use input() for Angular signals
    show = input.required<boolean>();

    // Use output() for Angular signals
    close = output<void>();
    upload = output<File[]>();
